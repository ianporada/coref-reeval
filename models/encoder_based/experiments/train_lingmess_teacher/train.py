...
@hydra.main(config_path='../../config', config_name='config_train_lingmess_teacher')
def main(cfg : DictConfig) -> None:
    pl.seed_everything(cfg['seed'])
    
    # Initialize the training_module 
    training_module=TrainingModule_lingmess_no_distillation(preprocessing_cfg=cfg["preprocessing_cfg"], model_cfg=cfg["model_cfg"], training_cfg=cfg["training_cfg"])
